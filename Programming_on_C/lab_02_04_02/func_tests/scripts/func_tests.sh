...
do 
    if [[ $i -lt 10 ]];then
        ...
        if [[ "$1" == "-v" || "$1" == "--verbose" ]];then
            ...
            ./pos_case.sh ./../data/pos_"$i"_in.txt ./../data/pos_"$i"_out.txt
        fi
...
do 
    if [[ $i -lt 10 ]];then
        ...
        if [[ "$i" == "2" || "$i" == "3" ]];then
            if [[ "$1" == "-v" || "$1" == "--verbose" ]];then
                    ./neg_case_rc.sh ./../data/neg_0"$i"_in.txt -v
            fi
            ./neg_case_rc.sh ./../data/neg_0"$i"_in.txt
            nc=0
            if ! ./pos_case.sh ./../data/neg_0"$i"_in.txt ./../data/neg_0"$i"_out.txt;then
                nc=$((nc+1))
            fi
            if ! ./neg_case_rc.sh ./../data/neg_0"$i"_in.txt;then
                nc=$((nc+1))
            fi
            ...
            if [[ "$1" == "-v" || "$1" == "--verbose" ]];then
                ...
                ./neg_case.sh ./../data/neg_0"$i"_in.txt
            fi
        ...
        if [[ "$1" == "-v" || "$1" == "--verbose" ]];then
            ...
            ./neg_case.sh ./../data/neg_"$i"_in.txt 
        fi
